...
const pillars = [
  {
    ...
    description:
      "Senior energy engineers, ECM specialists, and sustainability advisors who own the recommendation and the customer conversation.",
  },
  {
    icon: Bot,
    ...
    description:
      "Purpose-built agents that ingest legacy audits, draft ROM estimates, stack measures, and explain assumptions so experts focus on calibration and trade-offs.",
  },
  {
    icon: Zap,
    ...
    description:
      "Templated ECM calculations, sensitivity sweeps, CPQ handoffs, and M&V scaffolding generated automatically from site, asset, and tariff data.",
  },
  {
    icon: Database,
    title: "Unified Data Platform",
    tagline: "ONE SOURCE OF TRUTH FOR EVERY BUILDING",
    description:
      "RA+ resolves building identity, ingests meter and asset data, and exposes APIs that power discovery, scoping, proposals, and in-product recommendations.",
  },
];

const principles = [
  "Software absorbs the repeatable work; auditors own the judgment calls",
  "Every service line shares the same building data spine — no swivel-chair handoffs",
  "Agents are accountable to humans; humans are accountable to clients",
  "Automation targets 90%+ of recurring ECM scoping touches over the horizon",
];
